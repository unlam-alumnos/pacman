...
public class CronometroView extends View<CronometroView.MyView> {
    ...
    public void paint(Coordenada coordenada, String time) {
        ...
        ImageIcon sprite1 = new ImageIcon(JuegoConstants.SPRITES_PATH + "tablero/cronometro/" + time.charAt(0) + ".png");
        ImageIcon sprite2 = new ImageIcon(JuegoConstants.SPRITES_PATH + "tablero/cronometro/" + time.charAt(1) + ".png");
